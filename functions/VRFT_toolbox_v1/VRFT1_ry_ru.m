%
%             C = VRFT1_ry_ru(u,y,Mr,Mu,B,Wr,Wu,lambda,k,preFilt)
%    [C, theta] = VRFT1_ry_ru(u,y,Mr,Mu,B,Wr,Wu,lambda,k,preFilt)
%
...
% preFilt: if this parameter is set to 'n', prefiltering is disabled (the prefilter 
...
function [C, theta_vector] = VRFT1_ry_ru(u,y,Mr,Mu,B,Wr,Wu,lambda,k,preFilt)
...
if( isempty(preFilt) )  %controllo filtro
    ...
    L = minreal( minreal((1 - Mr)*Mr)*minreal(Wr*(U\1)) ); %inv(U)<->(U\1)  %calcolo il filtro ottimo
